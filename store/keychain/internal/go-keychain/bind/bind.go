...
import (
	...
	"github.com/docker/secrets-engine/store/keychain/internal/go-keychain"
)
...
func AddGenericPassword(service, account, label, password, accessGroup string) error {
...
func DeleteGenericPassword(service, account, accessGroup string) error {
