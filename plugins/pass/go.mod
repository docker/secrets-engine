...
require (
	...
	github.com/docker/secrets-engine/plugin v0.0.8
	github.com/docker/secrets-engine/store v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/docker/secrets-engine v0.0.7 // indirect
