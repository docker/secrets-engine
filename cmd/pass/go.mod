module github.com/docker/secrets-engine/cmd/pass
...
require (
	...
	github.com/docker/secrets-engine/pass v0.0.8
...
require (
	...
	github.com/docker/secrets-engine/engine v0.0.22 // indirect
	github.com/docker/secrets-engine/store v0.0.14 // indirect
