...
require (
	...
	github.com/docker/secrets-engine/pass v0.0.7
...
require (
	...
	github.com/docker/secrets-engine/engine v0.0.21 // indirect
	github.com/docker/secrets-engine/store v0.0.13 // indirect
