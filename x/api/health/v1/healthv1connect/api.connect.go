...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/docker/secrets-engine/x/api/health/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	VersionServiceName = "health.v1.VersionService"
)
...
const (
	...
	// RPC.
	VersionServiceGetVersionProcedure = "/health.v1.VersionService/GetVersion"
)

// VersionServiceClient is a client for the health.v1.VersionService service.
type VersionServiceClient interface {
	// GetVersion returns the version of the daemon.
	GetVersion(context.Context, *connect.Request[v1.GetVersionRequest]) (*connect.Response[v1.GetVersionResponse], error)
}

// NewVersionServiceClient constructs a client for the health.v1.VersionService service. By default,
...
func NewVersionServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) VersionServiceClient {
	...
	versionServiceMethods := v1.File_health_v1_api_proto.Services().ByName("VersionService").Methods()
...
// GetVersion calls health.v1.VersionService.GetVersion.
...
// VersionServiceHandler is an implementation of the health.v1.VersionService service.
...
func NewVersionServiceHandler(svc VersionServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/health.v1.VersionService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedVersionServiceHandler) GetVersion(context.Context, *connect.Request[v1.GetVersionRequest]) (*connect.Response[v1.GetVersionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("health.v1.VersionService.GetVersion is not implemented"))
}
